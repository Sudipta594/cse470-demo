...
class Patient{
	...
	public static function getPatientData($patient){
		...
		$heading = array("Name", "Location", "Age", "Phone", "Date of Birth", "Diagnosis", "Prescriptions", "Served By", "Print");
		$body = array();
	    ...
	    while($data = Db::assoc($query)){
			...
			Table::body(array($name, $location, $age, $phone, $dateOfBirth,  $diagnosis, $prescription, $servedBy, "<a href='print.php?patient=$token'>Print & Download</a>"));
			//array_push($body, ); 
